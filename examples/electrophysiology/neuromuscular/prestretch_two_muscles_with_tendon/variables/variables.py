...
precontraction_constant_body_force_muscle2 = (0,0,20*9.81e-4)   # [cm/ms^2], gravity constant for the body force
...
# load
prestretch_constant_body_force_muscle2 = (0,0,-1*9.81e-4)   # [cm/ms^2], gravity constant for the body force
