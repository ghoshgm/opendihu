...
#firing_times_file = "../../../input/MU_firing_times_never.txt" # no firing
...
# -----------------------------
# load
precontraction_constant_body_force_muscle1 = (0,0,-20*9.81e-4)   # [cm/ms^2], gravity constant for the body force
...
# -----------------------------
# load
prestretch_constant_body_force_muscle1 = (0,0,1*9.81e-4)   # [cm/ms^2], gravity constant for the body force
prestretch_top_traction = [0,0,10]        # [N]  (-30 also works)

# parameters for main simulation
# -------------------------------
# load
main_constant_body_force = (0,0,-9.81e-4)   # [cm/ms^2], gravity constant for the body force
main_bottom_traction = [0,0,-10]        # [N]  (-10/-30 works)
...
def muscle1_postprocess(data):
    ...
    change_of_muscle = muscle1_tendon_z - muscle1_streched_extend
    change_of_muscle_str.append(str(change_of_muscle))
    # open the file in the write mode
    with open('change_of_muscle_length.csv', 'w', encoding='UTF8', newline='') as f:
        # create the csv writer
        writer = csv.writer(f)
        # write a row to the csv file
        writer.writerow(change_of_muscle_str)
    print("Muscle1: t: {:6.2f}, avg. change of muscle length: {:+2.5f}".format(t, muscle1_tendon_z - muscle1_streched_extend))
